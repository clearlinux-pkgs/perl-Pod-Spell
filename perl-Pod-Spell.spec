...
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/Pod-Spell-1.25.tar.gz
...
%prep
%setup -q -n Pod-Spell-1.25
cd %{_builddir}
tar xf %{_sourcedir}/libpod-spell-perl_1.20-1.debian.tar.xz
cd %{_builddir}/Pod-Spell-1.25
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Pod-Spell-1.25/deblicense/
...
cp %{_builddir}/Pod-Spell-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Pod-Spell/b515fef4cff6ebb01089a366f04c4c8d0331f619 || :
...
/usr/share/package-licenses/perl-Pod-Spell/b515fef4cff6ebb01089a366f04c4c8d0331f619
